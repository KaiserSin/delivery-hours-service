...
class DeliveryHoursRouteTest {
    ...
    @Test
    fun `missing venue id returns bad request`() =
        testApplication {
            application { installRoutingWithService(mockk(relaxed = true)) }
    ...
    @Test
    fun `invalid city slug yields validation error`() =
        testApplication {
            application { installRoutingWithService(mockk(relaxed = true)) }
    ...
    @Test
    fun `invalid venue id yields validation error`() =
        testApplication {
            application { installRoutingWithService(mockk(relaxed = true)) }
    ...
    @Test
    fun `successful request delegates to service`() =
        testApplication {
    ...
    @Test
    fun `service exception bubbles as api error`() =
        testApplication {
            val service = mockk<DeliveryHoursApplicationService>()
